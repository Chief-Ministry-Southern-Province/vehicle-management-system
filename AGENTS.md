...
- Scheduled Journeys View opens a mobile-friendly details panel grouped into route/purpose/status, full departure and expected-return date-times, passengers, and vehicle/parking. Secondary vehicle, compliance, and reallocation information is expandable. Planned one-way and round-trip distances are explicitly distinguished; consolidated requests retain their individual details.
