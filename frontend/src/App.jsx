      ...
      <GoogleOAuthProvider clientId={import.meta.env.VITE_GOOGLE_CLIENT_ID}>
        <div className="w-full h-screen">
          ...
          <Routes>
            ...
            <Route
              path="/userdashboard"
              element={withAuth(<UserDashboard />)}
            />
            <Route
              path="/requesthistory"
              element={withAuth(<RequestHistory />)}
            />
            <Route
              path="/employee/requests/:id"
              element={withAuth(<EmployeeRequestDetails />)}
            />

            <Route
              path="/departmentofficerdashboard"
              element={withAuth(<DepartmentOfficerDashboard />)}
            />
            <Route
              path="/pendingrecommendations"
              element={withAuth(<PendingRecommendations />)}
            />
            <Route
              path="/employee/recommendations/:id"
              element={withAuth(<RecommendationReview />)}
            />
            <Route
              path="/departmentrequesthistory"
              element={withAuth(<DepartmentRequestHistory />)}
            />

            <Route
              path="/subjectofficerdashboard"
              element={withAuth(<SubjectOfficerDashboard />)}
            />
            <Route
              path="/vehicledirectory"
              element={withAuth(<VehicleDirectory />)}
            />
            <Route
              path="/vehicledetails/:registration"
              element={withAuth(<VehicleDetails />)}
            />
            <Route
              path="/driverdirectory"
              element={withAuth(<DriverDirectory />)}
            />
            <Route
              path="/driverdirectory/:driverId"
              element={withAuth(<DriverDatabaseDetails />)}
            />
            <Route
              path="/registervehicle"
              element={withAuth(<RegisterVehicle />)}
            />
            <Route
              path="/fuelmanagement"
              element={withAuth(<FuelManagement />)}
            />
            <Route
              path="/servicerecords"
              element={withAuth(<ServiceRecords />)}
            />
            <Route
              path="/repairrecords"
              element={withAuth(<RepairRecords />)}
            />
            <Route
              path="/fleetanalytics"
              element={withAuth(<FleetAnalytics />)}
            />
            <Route
              path="/approvedjourny"
              element={withAuth(<ApprovedJourny />)}
            />

            <Route
              path="/deputysecretarydashboard"
              element={withAuth(<DeputySecretaryDashboard />)}
            />
            <Route
              path="/seniordeputysecretarydashboard"
              element={withAuth(<SeniorDeputySecretaryDashboard />)}
            />
            <Route
              path="/totalapprovals"
              element={withAuth(<TotalApprovals />)}
            />
            <Route
              path="/pendingapprovals"
              element={withAuth(<PendingApprovals />)}
            />
            <Route
              path="/approval/:id"
              element={withAuth(<ApprovalWorkspace />)}
            />
            <Route
              path="/totalvehicles"
              element={withAuth(<TotalVehicles />)}
            />
            <Route
              path="/deputy/vehicles/:id"
              element={withAuth(<DeputyVehicleDetails />)}
            />
            <Route
              path="/driverdetails"
              element={withAuth(<DriverDetails />)}
            />
            <Route path="/drivers" element={withAuth(<DriverDetails />)} />

            <Route
              path="/finalapprovals"
              element={withAuth(<FinalApprovals />, [
                "secretary",
            ...
            <Route
              ...
              element={withAuth(<PendingFinalApprovals />, [
                "secretary",
                "senior_deputy_secretary",
              ])}
            />
            <Route
              path="/final-approvals/:id"
              element={withAuth(<FinalApprovalDetails />, [
                "secretary",
                "senior_deputy_secretary",
              ])}
            />
            ...
            <Route
              ...
              element={withAuth(<SecretaryDashboard />)}
            />

            <Route
              path="/driverdashboard"
              element={withAuth(<DriverDashboard />)}
            />
            <Route path="/tripshistory" element={withAuth(<TripsHistory />)} />
            <Route
              path="/reportvehicle"
              element={withAuth(<ReportVehicle />)}
            />
          </Routes>
        </div>
      </GoogleOAuthProvider>
