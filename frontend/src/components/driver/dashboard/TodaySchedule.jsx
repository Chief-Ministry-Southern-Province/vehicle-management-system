...
import { getDriverScheduledJourneys } from "../../../api/authApi";
...
export default function ScheduledJourney() {
  ...
  useEffect(() => {
    ...
    getDriverScheduledJourneys()
      ...
      .catch((requestError) => {
        if (active) setError(requestError?.message || "Unable to load scheduled journeys.");
      })
  ...
  return (
    <div className="rounded-2xl border bg-white p-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <span className="rounded-lg bg-blue-50 px-3 py-1 text-sm font-semibold text-blue-600">Upcoming</span>
      </div>
