      ...
      <div className="bg-white px-4 pt-4 pb-3 border-b sticky top-0 z-50">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <h1 className="font-bold text-lg mt-1">VMS Driver</h1>
          </div>

          <div className="text-right">
            <h3 className="font-semibold">DRV-B129</h3>

            <p className="text-xs text-slate-500">Operational Driver</p>
          </div>
        </div>
        ...
        <div className="bg-slate-50 border rounded-2xl p-4">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="font-semibold">Currently On Duty</h3>
      ...
      <div className="p-4 space-y-5">
        ...
        <div>
          <div className="flex justify-between mb-3">
            <h3 className="font-bold">Next Assignment</h3>
          ...
          <div className="bg-white rounded-2xl border p-4">
            <div className="flex justify-between mb-3">
              ...
              <span className="text-xs text-slate-500">ID: REQ-9902</span>
            </div>
            ...
            <h2 className="font-bold text-lg">VIP Transport: Ministry HQ</h2>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white rounded-2xl border p-4">
            ...
            <p className="text-sm text-slate-500">Today's Trips</p>
          ...
          <div className="bg-white rounded-2xl border p-4">
            ...
            <h3 className="text-3xl font-bold">124 km</h3>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border p-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="border rounded-xl p-3 text-center">
              ...
              <span className="text-xs text-slate-500">Odo</span>
            </div>
        ...
        <div className="bg-white rounded-2xl border p-4">
          <h3 className="font-semibold mb-5">Daily Schedule</h3>
          ...
          <div className="space-y-5">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-semibold">Airport Terminal 2</h4>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <h4 className="font-semibold mt-2">Ministry Headquarters</h4>

                <p className="text-xs text-slate-500">Meeting drop-off</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-semibold">Parliament House</h4>

                <p className="text-xs text-slate-500">
                  Return journey dispatch
                </p>

                <span className="text-xs text-slate-400">05:15 PM</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border rounded-2xl p-4">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-blue-600 font-medium mt-1">+1-800-VMS-CARE</p>
            </div>
          </div>
        </div>
      </div>
