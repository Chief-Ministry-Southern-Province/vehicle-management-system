        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900">GV-8842</h2>

                <p className="text-slate-500">Toyota Hilux</p>
              </div>
            </div>
          </div>
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <h3 className="mt-1 text-2xl font-bold text-slate-900">$775</h3>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
            ...
            <h3 className="mt-1 text-2xl font-bold text-slate-900">5 Days</h3>
          </div>
        </div>

        {/* Repair Summary */}
        <div className="mt-6 rounded-2xl border border-slate-200 p-5">
          <h3 className="font-semibold text-slate-900 mb-3">Repair Summary</h3>
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 p-5">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-slate-500">Spare Parts</span>

              <span className="font-medium">$450</span>
            </div>

            <div className="flex justify-between">
              <span className="text-slate-500">Labor Fees</span>
            ...
            <div className="border-t pt-3 flex justify-between">
              ...
              <span className="font-bold text-blue-600">$775</span>
            </div>
          </div>
        </div>
            ...
            <div className="rounded-2xl border border-slate-200 p-4 hover:bg-slate-50 transition">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Certified Document</p>
                </div>
              </div>
            </div>
          </div>
