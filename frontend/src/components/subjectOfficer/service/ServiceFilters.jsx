      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search vehicle, plate number, model, or service type..."
        ...
        <button type="button" onClick={onClear} className="flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-50">
          <FiX size={16} /> Clear
        </button>
      </div>
    </div>
