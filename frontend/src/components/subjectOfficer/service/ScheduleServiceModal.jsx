...
export default function ScheduleServiceModal({ isOpen, onClose }) {
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Create a maintenance schedule and notify vendors, transport
        ...
        <div className="max-h-[75vh] overflow-y-auto p-6">
          ...
          <div className="mt-6 rounded-2xl border border-amber-100 bg-amber-50 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-slate-900">Service Summary</h4>

                <p className="mt-1 text-sm text-slate-600">
                  Once submitted, the maintenance request will be assigned to
                  the selected vendor and become visible in the fleet
                  maintenance schedule dashboard for monitoring and approval.
                </p>
              </div>
            </div>
          </div>
