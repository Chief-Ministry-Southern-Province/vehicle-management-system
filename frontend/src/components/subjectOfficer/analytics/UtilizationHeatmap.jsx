      ...
      <div className="space-y-2">
        {days.map((day, rowIndex) => (
          <div key={day} className="flex items-center gap-2">
            ...
            {utilizationData[rowIndex].map((value, colIndex) => (
              <div
                key={colIndex}
      ...
      <div className="mt-6 border-t border-slate-100 pt-5">
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            <h4 className="mt-1 font-semibold text-slate-900">Friday</h4>
          </div>
          ...
          <div>
            ...
            <h4 className="mt-1 font-semibold text-slate-900">10:00 - 14:00</h4>
          </div>
          ...
          <div>
            ...
            <h4 className="mt-1 font-semibold text-blue-600">72.4%</h4>
          </div>
        </div>
      </div>
    </div>
