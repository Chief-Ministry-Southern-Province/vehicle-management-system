import { FiMapPin, FiInfo, FiUsers, FiCheckCircle } from "react-icons/fi";
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Configure the vehicle's initial assignment and operational
              deployment.
            </p>
          </div>
        </div>
      ...
      <div className="p-6">
        ...
        <div className="mt-5 rounded-2xl border border-amber-100 bg-amber-50 p-4">
          <div className="flex gap-3">
            ...
            <div>
              <h4 className="font-medium text-slate-800">Deployment Notice</h4>

              <p className="mt-1 text-sm text-slate-600">
                Newly registered vehicles remain inactive until the mandatory
                fleet inspection and compliance verification process is
                completed by the transport administration.
              </p>
            </div>
          </div>
        </div>
