        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Upload official vehicle photographs for fleet records and identification.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                Upload clear, high-resolution photographs showing
                the front, side, and rear views of the vehicle.
                These images assist with fleet verification,
