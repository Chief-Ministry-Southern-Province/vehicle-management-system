      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`rounded-xl px-4 py-2.5 text-sm font-semibold ${status === "all" ? "bg-blue-600 text-white" : "bg-slate-100 text-slate-600"}`}
          >
          ...
          <button
            ...
            className={`rounded-xl px-4 py-2.5 text-sm font-semibold ${status === "approved" ? "bg-emerald-600 text-white" : "bg-slate-100 text-slate-600"}`}
          >
