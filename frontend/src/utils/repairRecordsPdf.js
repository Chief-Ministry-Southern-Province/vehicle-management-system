...
export function generateRepairRecordsPdf(records, { recordKind = "Repair" } = {}) {
  ...
  printWindow.document.write(`<!doctype html><html><head><meta charset="utf-8"><title>Selected ${kind} Records</title><style>
    ...
    .summary { display:grid; grid-template-columns:repeat(3,1fr); gap:4mm; margin-bottom:5mm; } .summary div { border:.2mm solid #d6e0ea; border-radius:2mm; background:#f8fafc; padding:3mm 4mm; }
    ...
    td { border:.2mm solid #d6e0ea; padding:2.7mm 2mm; overflow-wrap:anywhere; } tbody tr:nth-child(even){background:#f8fafc} .number{text-align:right}
