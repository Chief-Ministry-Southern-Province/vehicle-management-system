...
export function generateDriverIssueRecordsPdf(reports) {
  ...
  printWindow.document.write(`<!doctype html><html><head><meta charset="utf-8"><title>Driver Issue Records</title><style>
    ...
    .sheet{position:relative;width:210mm;min-height:297mm;margin:0 auto 8mm;padding:48mm 18mm 21mm;background:#fff;page-break-after:always;overflow:hidden}.sheet:last-child{page-break-after:auto}
    .masthead{position:absolute;top:0;left:0;right:0;height:34mm;border-bottom:2.2mm solid #2c79c7;background:#0b2f5b;color:#fff;text-align:center;padding-top:17mm}.brand{font-size:18pt;font-weight:700;line-height:1}.sub{margin-top:3mm;color:#d6e7f7;font-size:8.8pt}
    .title{display:flex;justify-content:space-between;align-items:center;margin-bottom:7mm}h1{margin:0;font-size:22pt}.title p{margin:2mm 0 0;color:#647084;font-size:9pt}.badge{border-radius:20px;background:#fff1e6;color:#b45309;padding:3mm 6mm;font-size:8pt;font-weight:700;text-transform:uppercase}
    section{margin-bottom:5mm;break-inside:avoid}h2{margin:0 0 2.5mm;border-left:1.4mm solid #1558a6;padding:1.6mm 0 1.6mm 3mm;color:#0b2f5b;font-size:11pt;text-transform:uppercase}.grid{display:grid;grid-template-columns:1fr 1fr;border:.2mm solid #d6e0ea;border-bottom:0}
    .field{min-height:11.5mm;padding:2.4mm 3mm;border-bottom:.2mm solid #d6e0ea}.field:nth-child(4n+3),.field:nth-child(4n+4){background:#f8fafc}.field:nth-child(odd){border-right:.2mm solid #d6e0ea}.field span{display:block;margin-bottom:1.2mm;color:#647084;font-size:6.3pt;font-weight:700;text-transform:uppercase;letter-spacing:.35px}.field strong{display:block;white-space:pre-wrap;overflow-wrap:anywhere;font-size:8.1pt;line-height:1.25}
    .reference{margin-top:5mm;border-radius:2mm;background:#edf5fd;padding:4mm;color:#647084;font-size:7.2pt}.reference strong{display:block;margin-bottom:1.3mm;color:#0b2f5b;font-size:8pt}.footer{position:absolute;right:18mm;bottom:8mm;left:18mm;display:flex;justify-content:space-between;border-top:.2mm solid #d6e0ea;padding-top:4mm;color:#647084;font-size:7.5pt}
