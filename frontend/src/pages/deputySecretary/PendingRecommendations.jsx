...
import { getDeputyPendingRecommendations } from "../../api/authApi";
...
export default function PendingRecommendations() {
  ...
  useEffect(() => {
    const loadRequests = async () => {
      try {
        const response = await getDeputyPendingRecommendations();
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-slate-500">
            Review vehicle requests submitted by Department Officers.
          </p>
        </div>
