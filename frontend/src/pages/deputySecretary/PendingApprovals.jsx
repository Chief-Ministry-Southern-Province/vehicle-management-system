      ...
      <div className="space-y-6">
        <div className="flex flex-wrap gap-3 rounded-2xl border bg-white p-3 shadow-sm">
          <button
            ...
            className={`rounded-xl px-5 py-2.5 text-sm font-semibold ${view === "pending" ? "bg-amber-500 text-white" : "bg-slate-50 text-slate-600"}`}
          >
          ...
          <button
            ...
            className={`rounded-xl px-5 py-2.5 text-sm font-semibold ${view === "allocated" ? "bg-emerald-600 text-white" : "bg-slate-50 text-slate-600"}`}
          >
