  ...
  return (
    <div className="min-w-52 rounded-xl border border-slate-200 bg-white p-4 text-slate-900 shadow-xl">
      ...
      <div className="mt-3 space-y-2">
        <div className="flex items-center justify-between gap-6 text-sm"><span className="text-slate-500">Service cost</span><strong>{formatCurrency(cost, 2)}</strong></div>
        <div className="flex items-center justify-between gap-6 text-sm"><span className="text-slate-500">Completed</span><strong>{formatNumber(services)} services</strong></div>
      </div>
      ...
      <div className="mx-auto max-w-[1600px] space-y-6 pb-8">
        <header className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-900">Service &amp; Maintenance Records</h1>
            <p className="mt-2 max-w-2xl text-sm text-slate-500">Monitor monthly service costs and vehicle maintenance records.</p>
          </div>
        ...
        <section className="grid grid-cols-2 gap-2.5 sm:gap-3 xl:grid-cols-4" aria-label="Service performance summary">
        ...
        <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
          <div className="flex flex-col gap-4 border-b border-slate-200 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-900">Monthly Maintenance Overview</h2>
                <p className="mt-0.5 text-xs text-slate-500">Monthly service cost and completed services</p>
              </div>
            </div>
