          ...
          <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 p-10 text-white">
            ...
            <div className="relative">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-300">Chief Ministry</p>
              ...
              <div className="mt-16">
                ...
                <p className="mt-6 max-w-md text-lg leading-8 text-slate-300">
                  Register employees securely to access the official Government
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                ...
                <div>
                  <h4 className="font-semibold">Official Staff Portal</h4>
          ...
          <div className="bg-white p-8 md:p-12">
            <div className="mb-10">
              ...
              <p className="mt-3 text-slate-500">
                Fill in your official information to register for the Vehicle
                Management System.
              </p>
            </div>
 ...
 =========================== */}
            ...
            <div className="space-y-3 text-center">
              <p className="text-sm text-slate-500 leading-6">
                ...
                government officers to manage vehicle requests, approvals, fleet
              ...
              <div className="pt-4 border-t border-slate-200">
                <h4 className="font-semibold text-slate-800">Chief Ministry</h4>
