    ...
    try {
      ...
      switch (nextUser.role) {
        ...
        case "senior_deputy_secretary":
          navigate("/seniordeputysecretarydashboard");
          break;
        case "secretary":
            ...
            <div className="relative">
              ...
              <div className="mt-16">
                ...
                <p className="mt-6 max-w-lg text-lg leading-8 text-slate-300">
                  Sign in to securely access the official Government Vehicle
                  Management System and manage vehicle requests, approvals,
                  fleet operations, drivers and transport services.
                </p>
              </div>
            </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-300">
                      Protected access for authorized government officers.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/10 p-5 backdrop-blur-sm transition-all duration-300 hover:bg-white/15">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-300">
                      Modern vehicle request and fleet management platform for
            ...
            <div className="w-full max-w-md">
              <div className="mb-10 text-center">
                ...
                <p className="mt-3 text-slate-500 leading-7">
                  Enter your official government account credentials to
                  continue.
                </p>
              </div>
              ...
              <div className="space-y-4 text-center">
                <p className="text-sm leading-6 text-slate-500">
                  Secure access to the official Vehicle Management System for
                  government officers.
                </p>
                ...
                <div className="border-t border-slate-200 pt-5">
                  ...
                  <p className="mt-4 text-xs text-slate-400">
                    © {new Date().getFullYear()} Government of Sri Lanka. All
                    Rights Reserved.
                  </p>
                </div>
              </div>
