      ...
      <section className="flex min-h-screen items-center justify-center px-6 py-10 md:px-12 lg:px-20">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="mt-10 space-y-6">
            ...
            <div className="flex justify-between text-sm"><Link to="/forgot-password" className="font-medium text-blue-700 hover:text-blue-900">Forgot Password?</Link><Link to="/register" className="font-semibold text-blue-700 hover:text-blue-900">Create Account</Link></div>
          </form>
