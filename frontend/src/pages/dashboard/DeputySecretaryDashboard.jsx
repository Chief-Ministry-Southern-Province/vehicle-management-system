    ...
    <DashboardLayout>
      <div className="min-h-screen px-3 py-4 dark:bg-slate-950 sm:px-5 sm:py-6 lg:px-2">
        <div className="mx-auto max-w-[1600px] space-y-5 sm:space-y-7">
          <header className="relative overflow-hidden rounded-[20px] bg-linear-to-br from-slate-950 via-blue-950 to-indigo-900 px-4 py-4 text-white shadow-[0_20px_50px_-30px_rgba(30,64,175,0.8)] sm:px-6 sm:py-5 lg:px-7 lg:py-6">
            ...
            <div className="relative">
              <p className="text-[9px] font-bold uppercase tracking-[0.22em] text-cyan-300 sm:text-[10px]">Executive command centre</p>
              <h1 className="mt-1.5 text-xl font-bold leading-tight tracking-tight sm:text-2xl lg:text-[28px]">Assistance Secretary Dashboard</h1>
              <p className="mt-1.5 max-w-2xl text-xs leading-5 text-blue-100/80 sm:text-sm">Monitor fleet readiness, approvals and operational spending from one place.</p>
            </div>
          </header>
          <ExecutiveStats />
