...
class Vehicle extends Model
{
    protected $fillable = [
        ...
        'service_category', 'service_details', 'image_path',
    ];
    ...
    {
        return ['registration_expiry' => 'date:Y-m-d', 'revenue_license_expiry' => 'date:Y-m-d', 'last_service_date' => 'date:Y-m-d', 'service_details' => 'array'];
    }
