...
class Vehicle extends Model
{
    protected $fillable = [
        ...
        'fuel_type', 'fuel_capacity', 'fuel_efficiency', 'fuel_efficiency_unit', 'seat_capacity', 'technical_notes', 'registration_expiry', 'revenue_license_expiry', 'insurance_expiry', 'emission_expiry',
    ...
    {
        return ['registration_expiry' => 'date:Y-m-d', 'revenue_license_expiry' => 'date:Y-m-d', 'insurance_expiry' => 'date:Y-m-d', 'emission_expiry' => 'date:Y-m-d', 'last_service_date' => 'date:Y-m-d', 'fuel_efficiency' => 'decimal:2', 'service_details' => 'array', 'repair_details' => 'array', 'fuel_details' => 'array', 'image_paths' => 'array'];
    }
