...
class DriverController extends Controller
{
    ...
    private function tripPayload($trip, $group = null): array
    {
        ...
        return [
            ...
            'starting_location' => $group->pluck('starting_location')->filter()->unique()->implode(', '),
            'starting_latitude' => $group->count() === 1 ? $trip->starting_latitude : null,
            'starting_longitude' => $group->count() === 1 ? $trip->starting_longitude : null,
